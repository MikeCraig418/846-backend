...
class CreatePoliceBrutalityTable extends Migration {
	...
	public function up() {
		...
		Schema::create('link_submissions', function (Blueprint $table) {
			...
			$table->nullableTimestamps();
			$table->softDeletes();
			$table->text('github_title')->nullable();
			$table->text('github_description')->nullable();
			$table->text('github_links')->nullable();
			$table->text('github_tags')->nullable();
			$table->text('github_state')->nullable();
			$table->text('github_city')->nullable();
			$table->date('github_date')->nullable();
			$table->boolean('uncertain_github_date');
